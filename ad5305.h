...
#define AD5305_SLA_W 0x18
#define AD5305_SLA_R 0x19

void AD5305_Write(unsigned char pd0, 
...
unsigned int AD5305_Read(unsigned char chan)
{
    unsigned int data = 0;
